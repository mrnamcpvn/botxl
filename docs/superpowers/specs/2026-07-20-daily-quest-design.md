...
Mỗi ngày người chơi nhận 4 nhiệm vụ ngẫu nhiên. Hoàn thành nhận coin + đá + EXP + VIP Coin. Có vé reset quest trong shop. Bảng `daily_quests` đã có sẵn trong DB.
...
- **Reset 0h**: tự động xóa quest cũ, tạo 4 quest mới random (không trùng)
...
- **Vé reset quest**: bán trong shop (ID 26), giá 5000🪙. Dùng → xóa 1 quest đang có → random quest mới
- **VIP Coin**: mỗi quest hoàn thành +1 VIP Coin. Lưu trong `player_vip_coins`
- **Bonus đủ 4/4**: +1000🪙 + Đá cao cấp x1 + 2 VIP Coin
...
| ID | Tên | Giá | Mô tả |
|:---:|------|:---:|------|
| 26 | 🎫 Vé Reset Quest | 5000🪙 | Reset 1 nhiệm vụ ngẫu nhiên |

---

## 7. Lệnh

- `!quest` / `/quest` — xem 4 nhiệm vụ hôm nay, claim thưởng
